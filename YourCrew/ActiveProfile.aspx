<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ActiveProfile.aspx.cs" Inherits="ActiveProfile" %>
                              ...
                              <div class="row-fluid nomargin" id="divhirer" runat="server">
                                            <div class="span12">
                                               <h1>Active Your Account</h1>
                                                <label>Enter your email id and send activation message.</label><br />
                                                <asp:Label ID="lblMessage" runat="server" ></asp:Label><br />
                                                <asp:TextBox ID="txtEmailID" runat="server" Type="email" Width="30%"></asp:TextBox>
                                                <asp:Button ID="btnSand" runat="server" CssClass="btn btn-primary" OnClick="btnSand_Click"  Text="Send" />
                                                <br /><br />
                                                <br /><br />
                                                <br /><br />
                                            </div>
