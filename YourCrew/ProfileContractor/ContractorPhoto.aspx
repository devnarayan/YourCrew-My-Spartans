<%@ Page Title="" Language="C#" MasterPageFile="~/ProfileContractor/UnderPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="ContractorPhoto.aspx.cs" Inherits="ProfileContractor_ContractorPhoto" %>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td class="noti_Container2">
                                                <asp:LinkButton CssClass="btn btn-success" PostBackUrl="~/ProfileContractor/ContractorPhoto.aspx" Text="Photos" runat="server" ID="btnPhoto"><i class="icon icon-picture"></i> Photos</asp:LinkButton>
                                            </td>
