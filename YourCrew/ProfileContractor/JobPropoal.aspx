<%@ Page Title="" Language="C#" MasterPageFile="~/ProfileContractor/UnderPage.master" AutoEventWireup="true" CodeFile="JobPropoal.aspx.cs" Inherits="ProfileContractor_JobPropoal" %>
                            ...
                            <div class="span9">
                                ...
                                <article>
                                    <div class="post-heading">
                                        <h5> Contracts Proposals</h5>
                                    </div>
                                    <asp:ListView ID="listActiveJobs" GroupItemCount="1"
                                        OnItemCommand="datalistShowJobs_ItemCommand"
                                        runat="server">
                                        <LayoutTemplate>
                                            <div class="span12">
                                            ...
                                            <div class="row-fluid nomargin">
                                                <div class="span12">
                                                    ...
                                                    <table>
                                                        <tr>
                                                            <td>&nbsp;Budegt -
                                            <asp:Label ID="lbl_FJ_Budget" runat="server" Text='<%# Eval("Price","{0:C}") %>' Font-Size="16px"></asp:Label>
                                                            </td>
                                                            <td>&nbsp;&nbsp;Date: -<asp:Label ID="lbl_FJ_PostDate" runat="server" Text='<%# Eval("ProposalDate","{0:MMM dd-yyy hh:mm tt}") %>' Font-Size="16px"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2">Posted By: <a target="_blank" href="../ProfileHirer/ProfileHirer?HirerID=<%#Eval("HirerID") %>">
