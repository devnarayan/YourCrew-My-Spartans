<%@ Page Title="" Language="C#" MasterPageFile="~/ProfileContractor/UnderPage.master" AutoEventWireup="true" CodeFile="EditProfileHeader.aspx.cs" Inherits="ProfileContractor_EditProfileHeader" %>
                ...
                <section id="team">
                    <div id="thumbs">
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span9">
                                 <h5>Upload Profile Slider</h5>
                                <div class="row-fluid nomargin team-box thumbnail">
                                    <div class="span6 align-right text-right">
                                        <asp:FileUpload ID="fuslide" CssClass="text-right align-right" runat="server" />
                                    </div>
                                    <div class="span6">
                                ...
                                <%
                                    ...
                                    for (var i = 0; i < list2.Count; i++)
                                    {
                                        ...
                                        var row = "<div class='span10'><img src='UploadSlider/" + HiddenContractorID.Value + "/" + list2[i].ToString() + "' width='100%' height='100%' /></div>";
                                        Response.Write(row);
