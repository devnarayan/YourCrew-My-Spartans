<%@ Page Title="" Language="C#" MasterPageFile="~/ProfileContractor/UnderPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="ContractorVideo.aspx.cs" Inherits="ProfileContractor_ContractorVideo" %>
                ...
                <section id="team">
                    <div id="thumbs">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td class="noti_Container">
                                                <asp:LinkButton CssClass="btn btn-success" PostBackUrl="~/ProfileContractor/ContractorVideo.aspx" Text="Videos" runat="server" ID="btnVideo"><i class="icon icon-play"></i> Video</asp:LinkButton>
                                            </td>
                                            <td class="noti_Container1">
                                                <asp:LinkButton CssClass="btn btn-primary" Text="Comments" PostBackUrl="~/ProfileContractor/ContractorComments.aspx" runat="server" ID="LinkButton1"><i class="icon icon-comment" ></i> Comments</asp:LinkButton>
                        ...
                        <div class="row-fluid nomargin team-box thumbnail">
                            <div class="span6">
                                <div class="" id="divVideo" runat="server"></div>
                            </div>
                            <div class="span6 text-right">
                                <div id="search-form" class="search-form clearfix">
                                       <b>Video #1</b><br />
                                        <a id="video1" runat="server" class="text-warning  input-block-level font-" target="_blank"></a><br />
                                    <b>Video #2</b><br />
                                        <a id="video2" runat="server" class="text-warning  input-block-level font-" target="_blank"></a><br />
                                    <b>Video #3</b><br />
                                        <a id="video3" runat="server" class="text-warning  input-block-level font-" target="_blank"></a><br />
                                    <b>Video #4</b><br />
                                        <a id="video4" runat="server" class="text-warning  input-block-level font-" target="_blank"></a><br />
                                </div>
                            </div>
                        </div>
                    </div>
