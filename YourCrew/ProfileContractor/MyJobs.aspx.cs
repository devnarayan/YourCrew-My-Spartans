...
public partial class ProfileContractor_UploadPics_MyJobs : System.Web.UI.Page
{
    ...
    private void myjobs()
    {
        ...
        // Active Jobs
        string query2 = "select JID ,JobTitle, Description,StartDate,HirerId,ContractorID,Budget from ContractJobView where ContractorID='" + Convert.ToInt32(Session["ProfileID"]) + "' and  Status='Process' and Status!='Removed' order by Status, StartDate";
        ...
        //All Jobs
         query = "select JID ,JobTitle, Description,StartDate,HirerId,ContractorID,Budget from ContractJobView where ContractorID='" + Convert.ToInt32(Session["ProfileID"]) + "' and Status!='Praposal' and Status!='Process' and Status!='Removed' order by Status, StartDate";
         ad = new SqlDataAdapter(query, con);
         dt = new DataTable();
         ad.Fill(dt);
         listAllJobs.DataSource = dt;
         listAllJobs.DataBind();
    }
