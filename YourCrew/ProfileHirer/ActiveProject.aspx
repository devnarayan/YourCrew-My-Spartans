<%@ Page Title="" Language="C#" MasterPageFile="~/ProfileContractor/UnderPage.master" AutoEventWireup="true" CodeFile="ActiveProject.aspx.cs" Inherits="ProfileHirer_ActiveProject" %>
                            ...
                            <div class="span9">
                                <article>
                                    ...
                                    <div class="post-heading">
                                        <h3><a href="#">Active Contract</a></h3>
                                    </div>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                        ...
                                        SelectCommand="select ContractorJob.JID, Jobs.JobTitle,ContractorJob.StartDate,ProfileContractor.FirstName from Contractorjob inner join ProfileContractor on ContractorJob.ContractorID= ProfileContractor.ContractorID inner join Jobs on Jobs.JID=ContractorJob.JID where ContractorJob.HirerID=@UserName and ContractorJob.Status='Process'  order by ContractorJob.StartDate desc">
                                        <SelectParameters>
